    ...
    )
{
    ...
    if (strcmp(ParamName, "X_RDK_LinuxInterface") == 0)
    {
        /* collect value */
    ...
    )
{
    ...
    *pInsNumber                    = pDhcpSendOption->InstanceNumber;
    ...
    CosaDhcpv4RegSetDhcpv4Info((ANSC_HANDLE)g_Dhcpv4Object);
...
{
    UNREFERENCED_PARAMETER(hInsContext);
    PCOSA_DATAMODEL_DHCPV4          pMyObject    = (PCOSA_DATAMODEL_DHCPV4)g_Dhcpv4Object;
